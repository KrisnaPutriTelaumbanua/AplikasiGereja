...
@section('judul', 'Edit Data Ibadah')

@section('content')
    <form method="post" action="{{ url('ibadah/update/'.$ibadah->id_ibadah) }}">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="date"
                                   ...
                                   value="{{ old('tgl_ibadah', $ibadah->tgl_ibadah) }}"
                                   name="tgl_ibadah"
                                   id="tgl_ibadah">
                            @error('tgl_ibadah')
                        ...
                        <div class="form-group">
                            ...
                            <input type="time"
                                   ...
                                   value="{{ old('waktu_ibadah', $ibadah->waktu_ibadah) }}"
                                   name="waktu_ibadah"
                                   id="waktu_ibadah">
                            @error('waktu_ibadah')
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('id_kategori') is-invalid @enderror" name="id_kategori" id="id_kategori">
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id_kategori }}" {{ $ibadah->id_kategori == $category->id_kategori ? 'selected' : '' }}>
