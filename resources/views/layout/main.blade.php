...
<head>
    ...
    <title>Gereja Dashboard | @yield('judul')</title>
    ...
    <style>
        /* Background soft untuk konten utama */
        #content {
            background-color: #ecefef; /* Warna abu-abu sangat muda untuk kontras lembut */
            padding: 20px;
        }
        ...
        /* Styling tambahan */
        .scroll-to-top {
            background-color: #d3d3d3; /* Grey yang sedikit lebih tua dari konten */
        }
    </style>
